package com.example.boot01_2.jdbc;
...
public class DBUtils {
    ...
    */
    ...
    private static void init(){
        ...
        dds.setUrl("jdbc:mysql://localhost:3306/testUser?characterEncoding=utf8&useSSL=false&serverTimezone=Asia/Shanghai&rewriteBatchedStatements=true");
